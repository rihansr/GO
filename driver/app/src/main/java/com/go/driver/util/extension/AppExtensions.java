package com.go.driver.util.extension;
...
public class AppExtensions {
     ...
     **/
    public enum Photo {
        PROFILE, COVER, NID, LICENSE, OTHER
    }
    ...
    public enum TripRequest {
        Accept, Decline, Start, Finish, Contact
    }
    ...
    public static void setMapStyle(GoogleMap mMap){
        try {
            ...
            if (!isSuccess) {
                Log.i(Constants.TAG, "Map style load failed!!!");
            }
    ...
    public static String getAddress(double latitude, double longitude){
        try {
            Geocoder geocoder = new Geocoder(GoService.getContext(), Locale.getDefault());
            /**
    ...
    public static String showGreeting() {
        ...
        return greeting + (TempStorage.DRIVER == null ? "" : ", " + nameFormat(TempStorage.DRIVER.getName()));
    }

    public static void setDatePicker(final AppCompatEditText date_Input) {
        final DatePicker datePicker = new DatePicker(GoService.getActivity());
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(GoService.getActivity(), (datePicker1, year, monthOfYear, dayOfMonth) ->
        ...
        Calendar minDate = new GregorianCalendar(currentYear-100, currentMonth, currentDay);
        Calendar maxDate = new GregorianCalendar(currentYear-18, currentMonth, currentDay);
