...
public class PermissionManager {
    ...
    public PermissionManager() {
        this.activity = GoService.getActivity();
    }
    ...
    private void showPermissionSettingDialog(){
        ...
        AlertDialogFragment.show((HomeActivity) GoService.getActivity(), title, message, R.string.cancel, R.string.openSettings)
    ...
    public void goToPermissionSetting(){
        Activity activity = GoService.getActivity();
