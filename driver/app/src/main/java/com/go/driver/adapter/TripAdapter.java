...
public class TripAdapter extends RecyclerView.Adapter<TripAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final TripAdapter.ViewHolder holder, final int position) {
        ...
        holder.riderRating.setVisibility(getTripInfo(position).getDriverRating() != null ? View.VISIBLE : View.GONE);
        holder.riderRating.setRating(getTripInfo(position).getDriverRating() != null ? getTripInfo(position).getDriverRating() : 0);
