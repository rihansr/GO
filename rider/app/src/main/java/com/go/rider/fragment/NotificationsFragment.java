...
import com.go.rider.adapter.NotificationAdapter;
import com.go.rider.model.notification.Notification;
import com.go.rider.util.Constants;
import com.go.rider.util.recyclerView.DividerItemDecoration;
import com.go.rider.util.recyclerView.VerticalSpaceItemDecoration;
...
public class NotificationsFragment extends DialogFragment implements HomeActivity.OnNotificationListener{
