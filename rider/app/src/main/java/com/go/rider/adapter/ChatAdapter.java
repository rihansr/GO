...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, final int position) {
        ...
        if(holder instanceof SenderViewHolder){
            ...
            senderViewHolder.divider.setVisibility(isConditionMatch(position, 0) ? View.VISIBLE : View.GONE);
            ...
            receiverViewHolder.divider.setVisibility(isConditionMatch(position, 1) ? View.VISIBLE : View.GONE);

            if (isConditionMatch(position, 1)) {
